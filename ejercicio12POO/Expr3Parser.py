...
def serializedATN():
    return [
        4,1,26,15,2,0,7,0,2,1,7,1,1,0,5,0,6,8,0,10,0,12,0,9,9,0,1,0,1,0,
        1,1,1,1,1,1,0,0,2,0,2,0,1,1,0,1,25,13,0,7,1,0,0,0,2,12,1,0,0,0,4,
...
class Expr3Parser ( Parser ):
    ...
    literalNames = [ "<INVALID>", "'public'", "'class'", "'static'", "'void'", 
                     "'String'", "'int'", "'System'", "'new'", "'this'", 
                     "'return'", "'if'", "<INVALID>", "<INVALID>", "<INVALID>", 
                     "'>='", "'='", "'+'", "'.'", "';'", "'('", "')'", "'{'", 
                     "'}'", "'['", "']'" ]

    symbolicNames = [ "<INVALID>", "PUBLIC", "CLASS", "STATIC", "VOID", 
                      "STRING", "INT", "SYSTEM", "NEW", "THIS", "RETURN", 
                      "IF", "ID", "CADENA", "NUM", "MAYORIGUAL", "ASIGNACION", 
                      "MAS", "PUNTO", "PC", "PARENTESIS1", "PARENTESIS2", 
                      "LLAVE1", "LLAVE2", "CORCHETE1", "CORCHETE2", "WS" ]
    ...
    class ElementoContext(ParserRuleContext):
        ...
        def NEW(self):
            return self.getToken(Expr3Parser.NEW, 0)

        def THIS(self):
            return self.getToken(Expr3Parser.THIS, 0)

        def RETURN(self):
            return self.getToken(Expr3Parser.RETURN, 0)

        def IF(self):
            return self.getToken(Expr3Parser.IF, 0)
        ...
        def MAYORIGUAL(self):
            return self.getToken(Expr3Parser.MAYORIGUAL, 0)
