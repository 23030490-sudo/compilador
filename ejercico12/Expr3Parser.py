...
def serializedATN():
    return [
        4,1,23,15,2,0,7,0,2,1,7,1,1,0,5,0,6,8,0,10,0,12,0,9,9,0,1,0,1,0,
        1,1,1,1,1,1,0,0,2,0,2,0,1,1,0,1,22,13,0,7,1,0,0,0,2,12,1,0,0,0,4,
...
class Expr3Parser ( Parser ):
    ...
    symbolicNames = [ "<INVALID>", "PUBLIC", "CLASS", "STATIC", "VOID", 
                      "STRING", "INT", "SYSTEM", "IF", "ID", "CADENA", "NUM", 
                      "MAYORIGUAL", "ASIGNACION", "MAS", "PUNTO", "PC", 
                      "PARENTESIS1", "PARENTESIS2", "LLAVE1", "LLAVE2", 
    ...
    def root(self):
        ...
        try:
            ...
            while (((_la) & ~0x3f) == 0 and ((1 << _la) & 8388606) != 0):
                self.state = 4
                self.elemento()
                self.state = 9
                self._errHandler.sync(self)
    ...
    def elemento(self):
        ...
        try:
            ...
            self.state = 12
            _la = self._input.LA(1)
            if not((((_la) & ~0x3f) == 0 and ((1 << _la) & 8388606) != 0)):
